...
addCommandAlias("jmh1", "circeBenchmark/jmh:run -i 10 -wi 10 -f 1 -t 1 ugeneric.circe.benchmark.JsonStrictEncoderBenchmark.*")
addCommandAlias("jmh2", "circeBenchmark/jmh:run -i 10 -wi 10 -f 1 -t 1 ugeneric.circe.benchmark.JsonNonStrictEncoderBenchmark.*")
