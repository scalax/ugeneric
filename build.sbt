...
addCommandAlias("jmh1", "circeBenchmark/jmh:run -i 400 -wi 400 -f 1 -t 1 ugeneric.circe.benchmark.JsonStrictEncoderBenchmark.*")
addCommandAlias("jmh2", "circeBenchmark/jmh:run -i 400 -wi 400 -f 1 -t 1 ugeneric.circe.benchmark.JsonNonStrictEncoderBenchmark.*")
