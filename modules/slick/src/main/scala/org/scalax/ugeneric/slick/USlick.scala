...
object USlick {
  ...
  class ProvenShapeApply[Data] {
    def mapWithTable[Rep, HListDataType, Table <: AbstractTable[Data], P, RepType, DataType, EncodeRef, Packed1](
      table: Table
    )(
  ...
  def mapWithTable[Data](n: Context6[RepNode] => ProvenShapeApply[Data] => ProvenShape[Data]) = n(RepContext)(new ProvenShapeApply)
