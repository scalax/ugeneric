...
object RepNode {
  ...
  implicit def slickRepNodeApplication[F <: ShapeLevel, Rep, Data, Out](
    ...
    new Application6[RepNode, PropertyTag[Rep], PropertyTag[Data], Rep, Data, Any, Out] with RepNode[PropertyTag[Rep], PropertyTag[Data], Rep, Data, Any, Out] {
      ...
      override def application(context: Context6[RepNode]): RepNode[PropertyTag[Rep], PropertyTag[Data], Rep, Data, Any, Out] = this
    }
