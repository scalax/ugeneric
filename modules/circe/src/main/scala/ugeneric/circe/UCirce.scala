...
object UCirce {
  ...
  def encodeCaseClass[Model, R, Prop, Name](implicit
  ...
  def encodeCaseClassWithPlugin[Model, R, Prop, Name](p: Option[NameTranslator])(implicit
    ll: ZsgGeneric.Aux[Model, R],
    nImplicit: ZsgLabelledTypeGeneric.Aux[Model, Name],
  ...
  final def encodeSealed[Model, R, Cls, Lab](implicit
  ...
  final def encodeSealedWithPlugin[H, R, Cls, Lab](nameTranslator: Option[NameTranslator])(implicit
  ...
  def decodeCaseClass[Model, R, Prop, Name](implicit
    ll: ZsgGeneric.Aux[Model, R],
  ...
  def decodeCaseClassWithPlugin[Model, R, Prop, Name, DefaultValue](nameTranslator: Option[NameTranslator], useDefaultValue: Boolean)(implicit
    ll: ZsgGeneric.Aux[Model, R],
    tImplicit: ZsgLabelledTypeGeneric.Aux[Model, Name],
  ...
  def decodeSealedWithPlugin[H, R, Nam](nameTranslator: Option[NameTranslator])(implicit
    ll: ZsgSealedGeneric.Aux[H, R],
