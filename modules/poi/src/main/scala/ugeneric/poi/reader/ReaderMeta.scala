...
object ReaderMeta {
  ...
  object RequireImplicit {
    ...
    ): Application3[ReaderContent, PropertyTag1[FieldMeta[RequireImplicit, R, T], T], T, String, FieldMeta[RequireImplicit, R, T]] =
      new Application3[ReaderContent, PropertyTag1[FieldMeta[RequireImplicit, R, T], T], T, String, FieldMeta[RequireImplicit, R, T]] {
        override def application(context: Context3[ReaderContent]): ReaderContent[T, String, FieldMeta[RequireImplicit, R, T]] = {
          ...
          new ReaderContent[T, String, FieldMeta[RequireImplicit, R, T]] {
  ...
  object NotRequireImplicit {
    implicit def asunaPoiTypedReader[R, T]
      : Application3[ReaderContent, PropertyTag1[FieldMeta[NotRequireImplicit, R, T], T], T, String, FieldMeta[NotRequireImplicit, R, T]] =
      new Application3[ReaderContent, PropertyTag1[FieldMeta[NotRequireImplicit, R, T], T], T, String, FieldMeta[NotRequireImplicit, R, T]] {
        override def application(context: Context3[ReaderContent]): ReaderContent[T, String, FieldMeta[NotRequireImplicit, R, T]] = {
          def takeName(rep: FieldMeta[NotRequireImplicit, R, T], name: String): String = rep.fieldNameMeta.getOrElse(name)

          new ReaderContent[T, String, FieldMeta[NotRequireImplicit, R, T]] {
